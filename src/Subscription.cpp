...
SubscriptionState DynamicSubscription::subscriptionState() const
{
    ...
    case SRSN_YANG_PUSH_PERIODIC:
        state.params = YangPushPeriodic{
            ...
            Centiseconds(static_cast<Centiseconds::rep>(raw->yp_periodic.period)), // sysrepo reports in centiseconds, same unit as in the YANG model
    ...
    case SRSN_YANG_PUSH_ON_CHANGE: {
        ...
        state.params = YangPushOnChange{
            ...
            Centiseconds(static_cast<Centiseconds::rep>(raw->yp_on_change.dampening_period)),
