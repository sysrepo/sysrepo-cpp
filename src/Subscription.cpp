...
struct YangPushSubscription::Data {
...
YangPushSubscription::YangPushSubscription(std::shared_ptr<sr_session_ctx_s> sess, int fd, uint64_t subId)
    : m_data(std::make_unique<Data>(std::move(sess), fd, subId, false))
{
}

YangPushSubscription::YangPushSubscription(YangPushSubscription&&) noexcept = default;
YangPushSubscription& YangPushSubscription::operator=(YangPushSubscription&&) noexcept = default;
YangPushSubscription::~YangPushSubscription() = default;
...
uint64_t YangPushSubscription::subscriptionId() const
{
    return m_data->subId;
}
...
void YangPushSubscription::processEvents(YangPushNotifCb cb) const
{
