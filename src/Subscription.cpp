...
struct DynamicSubscription::Data {
    ...
    void modifyFilter(const SubscribedNotificationsFilter& filter);
};
...
void DynamicSubscription::modifyFilter(const SubscribedNotificationsFilter& filter)
{
...
void DynamicSubscription::Data::modifyFilter(const SubscribedNotificationsFilter& filter)
{
