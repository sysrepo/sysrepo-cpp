...
{
    return ChangeIterator{ChangeIterator::ChangeIteratorEnd{}};
}
...
ChangeIterator::ChangeIterator(const ChangeIteratorEnd)
...
/**
 * Compares if both iterators are the `.end` iterator.
 */
