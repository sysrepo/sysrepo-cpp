...
static_assert(static_cast<GetOptions>(SR_OPER_DEFAULT) == GetOptions::OperDefault);
...
static_assert(static_cast<GetOptions>(SR_OPER_NO_SUBS) == GetOptions::OperNoSubs);
static_assert(static_cast<GetOptions>(SR_OPER_NO_STORED) == GetOptions::OperNoStored);
static_assert(static_cast<GetOptions>(SR_OPER_WITH_ORIGIN) == GetOptions::OperWithOrigin);
static_assert(static_cast<GetOptions>(SR_OPER_NO_POLL_CACHED) == GetOptions::OperNoPollCached);
static_assert(static_cast<GetOptions>(SR_OPER_NO_RUN_CACHED) == GetOptions::OperNoRunCached);
