...
static_assert(toLogLevel(LogLevel::Err) == SR_LL_ERR);
static_assert(toLogLevel(LogLevel::Wrn) == SR_LL_WRN);
static_assert(toLogLevel(LogLevel::Inf) == SR_LL_INF);
static_assert(toLogLevel(LogLevel::Dbg) == SR_LL_DBG);
}
