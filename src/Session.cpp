 ...
 *
 * @param path XPath which corresponds to the data that should be retrieved.
 * @returns std::nullopt if no matching node found, otherwise the requested data node.
 */
std::optional<libyang::DataNode> Session::getOneNode(const std::string& path) const
{
    sr_data_t* data;
