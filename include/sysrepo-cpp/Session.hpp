...
public:
    ...
    [[nodiscard]] Subscription subModuleChange(const char* moduleName, ModuleChangeCb cb, const char* xpath = nullptr, uint32_t priority = 0, const SubOptions opts = SubOptions::Default);
