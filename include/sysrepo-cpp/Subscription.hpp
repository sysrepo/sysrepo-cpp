...
using NotifCb = std::function<void(Session session, uint32_t subscriptionId, const NotificationType type, const libyang::DataNode notificationTree, const NotificationTimeStamp timestamp)>;
