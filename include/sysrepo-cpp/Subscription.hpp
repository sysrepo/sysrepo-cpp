...
struct YangPushPeriodic {
    Datastore datastore;
    std::chrono::milliseconds period; /**< Reported at the ietf-yang-push resolution of 10 ms (centiseconds). */
...
struct YangPushOnChange {
    Datastore datastore;
    std::chrono::milliseconds dampeningPeriod; /**< Reported at the ietf-yang-push resolution of 10 ms (centiseconds). */
